...
?>
    <tr>
        ...
        <td><a href="editmenu.php?menuID=<?=$row["menuID"]?>&username=<?php echo urlencode($username); ?>" class="btn btn-warning">แก้ไขเมนู</a></td>
        <td><a href="deletemenu.php?menuID=<?=$row["menuID"]?>&username=<?php echo urlencode($username); ?>" class="btn btn-danger" onclick="Del(this.href);return false;">ลบเมนู</a></td>
    </tr>
<?php
}
?>
