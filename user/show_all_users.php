...
<div class="sidebar">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <button type="button" onclick="window.location.href='../edituser/edituser.php?username=<?=htmlspecialchars($row['username'])?>&usename=<?php echo urlencode($username); ?>'" class="submit-btn">แก้ไขข้อมูลผู้ใช้</button>
            </td>
            <td>
                <button type="button" onclick="window.location.href='../edituser/edituser.php?username=<?=htmlspecialchars($row['username'])?>&usename=<?php echo urlencode($username); ?>'" class="back-btn">ลบผู้ใช้</button>
